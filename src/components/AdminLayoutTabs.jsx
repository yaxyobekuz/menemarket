...
const AdminLayoutTabs = () => {
  return (
    <nav className="sidebar-layout-tabs fixed bottom-0 inset-x-0 w-full bg-white border-t sm:hidden">
          ...
          >
            ...
            >
              <rect
                ...
                className="transition-colors duration-300"
              />
              <rect x="3" y="3" rx="9" width="18" height="18" fill="white" />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                fill="currentColor"
